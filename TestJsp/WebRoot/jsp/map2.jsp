	...
	<script type="text/javascript">
		...
		var geoCoordMap = {
			...
			var SHData = [
			    ...
			    [{name:'昆明'},{name:'上海',value:90}],
			    [{name:'广州'},{name:'上海',value:80}],
			    [{name:'郑州'},{name:'上海',value:70}],
			    [{name:'长春'},{name:'上海',value:60}],
			    [{name:'重庆'},{name:'上海',value:50}],
			    [{name:'长沙'},{name:'上海',value:40}],
			    [{name:'北京'},{name:'上海',value:30}],
			    [{name:'丹东'},{name:'上海',value:20}],
			    [{name:'大连'},{name:'上海',value:10}]
			];
			        ...
			        label: {
			            normal: {
			                ...
			                formatter: function (dataItem){
			                	...
			                	return dataItem.data.name+':'+dataItem.value[2];
			                }
			            }
			        },
